...
function [model,P] = DrawUnitCell(model,P)
...
cyl_cut.set('type','solid').set('pos',[0,0]).set('size',[P.beamLen,P.airrad]);
...
%% Symmetry in z
if strcmp(P.xsect,'rect') && abs(P.obevenz)
    symZth = P.airrad;
    symW = P.airrad;
    ...
    ZsymSel.set('ymin', -delta).set('ymax', P.airrad+delta);
...
XsymSel.set('ymin', -delta).set('ymax', P.airrad+delta);
XsymSel.set('zmin', -P.airrad*(1-evenz)-delta).set('zmax', P.airrad+delta);
...
XendSel.set('ymin', -delta).set('ymax', P.airrad+delta);
XsymSel.set('zmin', -P.airrad*(1-evenz)-delta).set('zmax', P.airrad+delta);
...
YsymSel.set('zmin', -P.airrad*(1-evenz)-delta).set('zmax', P.airrad+delta);
...
cylCurvSel.set('ymin', P.airrad-delta).set('ymax', P.airrad+delta);
