...
function ds = solveBands2DSquareLattice(P,datLoc)
...
if isempty(dir([datLoc,fBase,'_bds.mat']))
    ...
    P.mbevenz = 1;
    sym = RunBands2DSquareLattice(P,datLoc);
    ...
    if P.solveasym == 1
        ...
        P.mbevenz = -1;
        asym = RunBands2DSquareLattice(P,datLoc);
...
%         set(gca,'XTickLabel',{'G','C'},'fontname','symbol','fontsize',16)
        ...
        celltypeTitle = sym.P.celltypeTitle;
        bandtitle = {[celltypeTitle,', ',...
