...
P.wgmTaper.a_end = 426e-9;              % for endtype = 'custom': lattice constant of end hole
P.wgmTaper.hx_end = 213e-9;             % for endtype = 'custom': hole height of end hole
P.wgmTaper.hy_end = 173e-9;             % for endtype = 'custom': hole width of end hole
...
P.freq = 5.5e9;                           % target mechanical frequency
