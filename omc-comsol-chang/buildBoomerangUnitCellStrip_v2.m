...
model.param.set('b',        sprintf('%.12g[m]', b));
...
model.param.set('sel_w',    sprintf('%.12g[m]', 2.5e-9));
...
beamSel.set('ymin', '-delta').set('ymax', 'sqrt(3)*a*4+delta');
beamSel.set('zmin', '-delta').set('zmax', 'th/2+delta');
