...
P.a_ctr = 0.5*P.a;                          % for taperTo = 'custom': lattice constant of center cell
P.hx_ctr = 0.5*P.hx;                        % for taperTo = 'custom': length of block of center cell
P.hy_ctr = P.hy;                            % for taperTo = 'custom': width of tethers from center cell
P.w_ctr = P.w;                    % for taperTo = 'custom': width of center cell
...
LStats.ymin = P.hy_ctr/2;
LStats.ymax = P.hy_ctr/2+50e-9;
LStats.zmin = P.th/2-60e-9;
LStats.zmax = P.th/2-40e-9;
P.LStats = LStats;
%% Simulation settings
