...
% minfitness = runNanobeamFEM(params0);
% fprintf('the minimum fitness %.2f',minfitness);

%% run the optimization code 
options = optimset('PlotFcns',@optimplotfval);
func = @(params) runNanobeamFEM(params);
params = fminsearch(func,params0);
%% optimization functions 
function minFitness = runNanobeamFEM(params)
    %% optimization file name 
    currentDate = datestr(now,'mmddyyyy');
    optFilename = ['optimizeData_',currentDate,'.csv'];
    ...
    P.maxdef = params(1);                     % defect percentage
    ...
    P.nbeam = 2.403;                        % the refractive index of diamond at telecom
    ...
    % record the data 
    data = [P.maxdef,P.oblong,P.a,P.w,P.th,P.hx,P.hy,...
