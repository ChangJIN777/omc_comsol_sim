...
P.freq = 8.5e9;                           % target mechanical frequency
...
P.ySlc = 0;
P.zSlc = P.th/2-100e-9; %swelling mode
...
P.LStats.zmin = P.th/2-200e-9;   % z-coords relative to center of beam
...
datLoc = 'G:\My Drive\OMC\COMSOL\NanobeamFEM190919\OMCTri45SwellCpl\'; 
