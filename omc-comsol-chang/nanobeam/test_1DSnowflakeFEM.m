...
P.wo = 557e-9;           % the height of the hole in the lower portion
...
P.ho_ctr = 257e-9;                    % for taperTo = 'custom': hole height of center hole
P.hi_ctr = 175e-9;
P.wo_ctr = 478e-9;                    % for taperTo = 'custom': hole width of center hole
...
P.mMesh = 8;                            % mesh quality for mechanical simulations
...
P.oneigs = 5;                           % # of eigenvalues to find
P.oMesh = 8;                            % mesh quality for optical simulations
