...
P.a = 558e-9;                           % nominal lattice constant
P.w = 763e-9;                           % beam width
P.theta = 45;                           % etch angle in degrees (no effect for rect cross section)
P.th = 344e-9;                          % beam thickness
P.hx = 190e-9;                          % nominal hole height (along x-axis)
P.hy = 591e-9;                          % nominal hole width (along y-axis)
...
P.maxdef = 0.2044;                     % defect percentage
P.oblong = 2.1520;                      % oblong parameter (zero if holes are not changed)
...
P.wgmTaper.a_end = 419e-9;              % for endtype = 'custom': lattice constant of end hole
P.wgmTaper.hx_end = 151e-9;             % for endtype = 'custom': hole height of end hole
P.wgmTaper.hy_end = 208e-9;             % for endtype = 'custom': hole width of end hole
