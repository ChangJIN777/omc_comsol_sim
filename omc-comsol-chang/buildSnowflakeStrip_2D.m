...
% hole #1 
c1_rec_1 = ucellgeom.feature.create('c1_r1', 'Rectangle');
c1_rec_1.set('pos', [0 a*sqrt(3)/2+b]);
c1_rec_1.set('base', 'center');
c1_rec_1.set('size', [2*r w]);

c1_rec_2 = ucellgeom.feature.create('c1_r2', 'Rectangle');
c1_rec_2.set('pos', [0 a*sqrt(3)/2+b]);
c1_rec_2.set('rot', 60);
c1_rec_2.set('base', 'center');
c1_rec_2.set('size', [2*r w]);

c1_rec_3 = ucellgeom.feature.create('c1_r3', 'Rectangle');
c1_rec_3.set('pos', [0 a*sqrt(3)/2+b]);
c1_rec_3.set('rot', 120);
c1_rec_3.set('base', 'center');
c1_rec_3.set('size', [2*r w]);

% hole #2 
c2_rec_1 = ucellgeom.feature.create('c2_r1', 'Rectangle');
c2_rec_1.set('pos', [0 -(a*sqrt(3)/2+b)]);
c2_rec_1.set('base', 'center');
c2_rec_1.set('size', [2*r w]);

c2_rec_2 = ucellgeom.feature.create('c2_r2', 'Rectangle');
c2_rec_2.set('pos', [0 -(a*sqrt(3)/2+b)]);
c2_rec_2.set('rot', 60);
c2_rec_2.set('base', 'center');
c2_rec_2.set('size', [2*r w]);

c2_rec_3 = ucellgeom.feature.create('c2_r3', 'Rectangle');
c2_rec_3.set('pos', [0 -(a*sqrt(3)/2+b)]);
c2_rec_3.set('rot', 120);
c2_rec_3.set('base', 'center');
c2_rec_3.set('size', [2*r w]);

% hole #3 
c3_rec_1 = ucellgeom.feature.create('c3_r1', 'Rectangle');
c3_rec_1.set('pos', [0 a*sqrt(3)/2+sqrt(3)*a]);
c3_rec_1.set('base', 'center');
c3_rec_1.set('size', [2*r w]);

c3_rec_2 = ucellgeom.feature.create('c3_r2', 'Rectangle');
c3_rec_2.set('pos', [0 a*sqrt(3)/2+sqrt(3)*a]);
c3_rec_2.set('rot', 60);
c3_rec_2.set('base', 'center');
c3_rec_2.set('size', [2*r w]);

c3_rec_3 = ucellgeom.feature.create('c3_r3', 'Rectangle');
c3_rec_3.set('pos', [0 a*sqrt(3)/2+sqrt(3)*a]);
c3_rec_3.set('rot', 120);
c3_rec_3.set('base', 'center');
c3_rec_3.set('size', [2*r w]);

% hole #4 
c4_rec_1 = ucellgeom.feature.create('c4_r1', 'Rectangle');
c4_rec_1.set('pos', [0 a*sqrt(3)/2+2*sqrt(3)*a]);
c4_rec_1.set('base', 'center');
c4_rec_1.set('size', [2*r w]);

c4_rec_2 = ucellgeom.feature.create('c4_r2', 'Rectangle');
c4_rec_2.set('pos', [0 a*sqrt(3)/2+2*sqrt(3)*a]);
c4_rec_2.set('rot', 60);
c4_rec_2.set('base', 'center');
c4_rec_2.set('size', [2*r w]);

c4_rec_3 = ucellgeom.feature.create('c4_r3', 'Rectangle');
c4_rec_3.set('pos', [0 a*sqrt(3)/2+2*sqrt(3)*a]);
c4_rec_3.set('rot', 120);
c4_rec_3.set('base', 'center');
c4_rec_3.set('size', [2*r w]);

% hole #5
c5_rec_1 = ucellgeom.feature.create('c5_r1', 'Rectangle');
c5_rec_1.set('pos', [0 -(a*sqrt(3)/2+sqrt(3)*a)]);
c5_rec_1.set('base', 'center');
c5_rec_1.set('size', [2*r w]);

c5_rec_2 = ucellgeom.feature.create('c5_r2', 'Rectangle');
c5_rec_2.set('pos', [0 -(a*sqrt(3)/2+sqrt(3)*a)]);
c5_rec_2.set('rot', 60);
c5_rec_2.set('base', 'center');
c5_rec_2.set('size', [2*r w]);

c5_rec_3 = ucellgeom.feature.create('c5_r3', 'Rectangle');
c5_rec_3.set('pos', [0 -(a*sqrt(3)/2+sqrt(3)*a)]);
c5_rec_3.set('rot', 120);
c5_rec_3.set('base', 'center');
c5_rec_3.set('size', [2*r w]);

% hole #6
c6_rec_1 = ucellgeom.feature.create('c6_r1', 'Rectangle');
c6_rec_1.set('pos', [0 -(a*sqrt(3)/2+2*sqrt(3)*a)]);
c6_rec_1.set('base', 'center');
c6_rec_1.set('size', [2*r w]);

c6_rec_2 = ucellgeom.feature.create('c6_r2', 'Rectangle');
c6_rec_2.set('pos', [0 -(a*sqrt(3)/2+2*sqrt(3)*a)]);
c6_rec_2.set('rot', 60);
c6_rec_2.set('base', 'center');
c6_rec_2.set('size', [2*r w]);

c6_rec_3 = ucellgeom.feature.create('c6_r3', 'Rectangle');
c6_rec_3.set('pos', [0 -(a*sqrt(3)/2+2*sqrt(3)*a)]);
c6_rec_3.set('rot', 120);
c6_rec_3.set('base', 'center');
c6_rec_3.set('size', [2*r w]);

% hole #7
c7_rec_1 = ucellgeom.feature.create('c7_r1', 'Rectangle');
c7_rec_1.set('pos', [a/2 sqrt(3)*a]);
c7_rec_1.set('base', 'center');
c7_rec_1.set('size', [2*r w]);

c7_rec_2 = ucellgeom.feature.create('c7_r2', 'Rectangle');
c7_rec_2.set('pos', [a/2 sqrt(3)*a]);
c7_rec_2.set('rot', 60);
c7_rec_2.set('base', 'center');
c7_rec_2.set('size', [2*r w]);

c7_rec_3 = ucellgeom.feature.create('c7_r3', 'Rectangle');
c7_rec_3.set('pos', [a/2 sqrt(3)*a]);
c7_rec_3.set('rot', 120);
c7_rec_3.set('base', 'center');
c7_rec_3.set('size', [2*r w]);

% hole #8
c8_rec_1 = ucellgeom.feature.create('c8_r1', 'Rectangle');
c8_rec_1.set('pos', [-a/2 sqrt(3)*a]);
c8_rec_1.set('base', 'center');
c8_rec_1.set('size', [2*r w]);

c8_rec_2 = ucellgeom.feature.create('c8_r2', 'Rectangle');
c8_rec_2.set('pos', [-a/2 sqrt(3)*a]);
c8_rec_2.set('rot', 60);
c8_rec_2.set('base', 'center');
c8_rec_2.set('size', [2*r w]);

c8_rec_3 = ucellgeom.feature.create('c8_r3', 'Rectangle');
c8_rec_3.set('pos', [-a/2 sqrt(3)*a]);
c8_rec_3.set('rot', 120);
c8_rec_3.set('base', 'center');
c8_rec_3.set('size', [2*r w]);

% hole #9
c9_rec_1 = ucellgeom.feature.create('c9_r1', 'Rectangle');
c9_rec_1.set('pos', [a/2 -sqrt(3)*a]);
c9_rec_1.set('base', 'center');
c9_rec_1.set('size', [2*r w]);

c9_rec_2 = ucellgeom.feature.create('c9_r2', 'Rectangle');
c9_rec_2.set('pos', [a/2 -sqrt(3)*a]);
c9_rec_2.set('rot', 60);
c9_rec_2.set('base', 'center');
c9_rec_2.set('size', [2*r w]);

c9_rec_3 = ucellgeom.feature.create('c9_r3', 'Rectangle');
c9_rec_3.set('pos', [a/2 -sqrt(3)*a]);
c9_rec_3.set('rot', 120);
c9_rec_3.set('base', 'center');
c9_rec_3.set('size', [2*r w]);

% hole #10
c10_rec_1 = ucellgeom.feature.create('c10_r1', 'Rectangle');
c10_rec_1.set('pos', [-a/2 -sqrt(3)*a]);
c10_rec_1.set('base', 'center');
c10_rec_1.set('size', [2*r w]);

c10_rec_2 = ucellgeom.feature.create('c10_r2', 'Rectangle');
c10_rec_2.set('pos', [-a/2 -sqrt(3)*a]);
c10_rec_2.set('rot', 60);
c10_rec_2.set('base', 'center');
c10_rec_2.set('size', [2*r w]);

c10_rec_3 = ucellgeom.feature.create('c10_r3', 'Rectangle');
c10_rec_3.set('pos', [-a/2 -sqrt(3)*a]);
c10_rec_3.set('rot', 120);
c10_rec_3.set('base', 'center');
c10_rec_3.set('size', [2*r w]);

% hole #11
c11_rec_1 = ucellgeom.feature.create('c11_r1', 'Rectangle');
c11_rec_1.set('pos', [a/2 sqrt(3)*a+a*sqrt(3)]);
c11_rec_1.set('base', 'center');
c11_rec_1.set('size', [2*r w]);

c11_rec_2 = ucellgeom.feature.create('c11_r2', 'Rectangle');
c11_rec_2.set('pos', [a/2 sqrt(3)*a+a*sqrt(3)]);
c11_rec_2.set('rot', 60);
c11_rec_2.set('base', 'center');
c11_rec_2.set('size', [2*r w]);

c11_rec_3 = ucellgeom.feature.create('c11_r3', 'Rectangle');
c11_rec_3.set('pos', [a/2 sqrt(3)*a+a*sqrt(3)]);
c11_rec_3.set('rot', 120);
c11_rec_3.set('base', 'center');
c11_rec_3.set('size', [2*r w]);

% hole #12
c12_rec_1 = ucellgeom.feature.create('c12_r1', 'Rectangle');
c12_rec_1.set('pos', [-a/2 sqrt(3)*a+a*sqrt(3)]);
c12_rec_1.set('base', 'center');
c12_rec_1.set('size', [2*r w]);

c12_rec_2 = ucellgeom.feature.create('c12_r2', 'Rectangle');
c12_rec_2.set('pos', [-a/2 sqrt(3)*a+a*sqrt(3)]);
c12_rec_2.set('rot', 60);
c12_rec_2.set('base', 'center');
c12_rec_2.set('size', [2*r w]);

c12_rec_3 = ucellgeom.feature.create('c12_r3', 'Rectangle');
c12_rec_3.set('pos', [-a/2 sqrt(3)*a+a*sqrt(3)]);
c12_rec_3.set('rot', 120);
c12_rec_3.set('base', 'center');
c12_rec_3.set('size', [2*r w]);

% hole #13
c13_rec_1 = ucellgeom.feature.create('c13_r1', 'Rectangle');
c13_rec_1.set('pos', [a/2 -sqrt(3)*a-a*sqrt(3)]);
c13_rec_1.set('base', 'center');
c13_rec_1.set('size', [2*r w]);

c13_rec_2 = ucellgeom.feature.create('c13_r2', 'Rectangle');
c13_rec_2.set('pos', [a/2 -sqrt(3)*a-a*sqrt(3)]);
c13_rec_2.set('rot', 60);
c13_rec_2.set('base', 'center');
c13_rec_2.set('size', [2*r w]);

c13_rec_3 = ucellgeom.feature.create('c13_r3', 'Rectangle');
c13_rec_3.set('pos', [a/2 -sqrt(3)*a-a*sqrt(3)]);
c13_rec_3.set('rot', 120);
c13_rec_3.set('base', 'center');
c13_rec_3.set('size', [2*r w]);

% hole #14
c14_rec_1 = ucellgeom.feature.create('c14_r1', 'Rectangle');
c14_rec_1.set('pos', [-a/2 -sqrt(3)*a-a*sqrt(3)]);
c14_rec_1.set('base', 'center');
c14_rec_1.set('size', [2*r w]);

c14_rec_2 = ucellgeom.feature.create('c14_r2', 'Rectangle');
c14_rec_2.set('pos', [-a/2 -sqrt(3)*a-a*sqrt(3)]);
c14_rec_2.set('rot', 60);
c14_rec_2.set('base', 'center');
c14_rec_2.set('size', [2*r w]);

c14_rec_3 = ucellgeom.feature.create('c14_r3', 'Rectangle');
c14_rec_3.set('pos', [-a/2 -sqrt(3)*a-a*sqrt(3)]);
...
hole_pos = [0 a*sqrt(3)/2+b; 0 -(a*sqrt(3)/2+b); 0 a*sqrt(3)/2+sqrt(3)*a;
    0 a*sqrt(3)/2+2*sqrt(3)*a; 0 -(a*sqrt(3)/2+sqrt(3)*a);0 -(a*sqrt(3)/2+2*sqrt(3)*a);
    a/2 sqrt(3)*a; -a/2 sqrt(3)*a; a/2 -sqrt(3)*a; -a/2 -sqrt(3)*a;
    a/2 sqrt(3)*a+a*sqrt(3); -a/2 sqrt(3)*a+a*sqrt(3); a/2 -sqrt(3)*a-a*sqrt(3);
    -a/2 -sqrt(3)*a-a*sqrt(3)];

selection_width = 10e-9;
for i=1:14
    addFillet(P,ucellgeom,i,hole_pos(i,:),selection_width);
end
