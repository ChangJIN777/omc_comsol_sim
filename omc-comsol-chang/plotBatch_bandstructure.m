...
if P.bandStruct_2D
    ...
    if P.TwoSymPlanes
        ...
        % asymmetric bandgaps
        if P.solveasym && exist('asym','var') && isfield(asym,'gapSize')
        ...
        if P.solveasym && exist('asym','var') && isfield(asym,'F')
